<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KayitOl.aspx.vb" Inherits="Proje_OkulKayıt.KayitOl" %>
...
<head>
    <title>Öğrenci Okul Kayıt</title>
    <!-- Meta tag Keywords -->
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" placeholder="@gmail.com"></asp:TextBox>
                            required="">
                    </div>
                    <div class="form-group">
